...
const mockOrder: OrderModel = {
  ...
  dishes: [
    {
      ...
      priceCents: 2150,
      id: 1,
      orderer: { id: 123, email: 'example123@example.com' },
      paid: false,
    },
    {
      name: 'mockDish 2',
      priceCents: 1030,
      id: 2,
      orderer: { id: 321, email: 'example321@example.com' },
      paid: false,
    },
    {
      name: 'mockDish 3',
      priceCents: 3820,
      id: 3,
      orderer: { id: 222, email: 'example22@example.com' },
      paid: false,
    },
  ],
  id: '',
  ...
  updatedAt: initDate,
  user: { id: 123, email: 'example@example.com' },
};
      ...
      <Grid item xs={12} sm={6} style={{ paddingTop: '0' }}>
        <Typography variant="subtitle1">
          ...
          {props.order.shippingCents &&
            PriceFormatter(
              props.order.shippingCents,
              props.order.dishes.map(
                (dish: any) => (dish as DishModel).priceCents
              )
            )}
        </Typography>
      </Grid>
