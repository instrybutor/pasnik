...
export class AddRequestAccess1643195587410 implements MigrationInterface {
    name = 'AddRequestAccess1643195587410'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "workspace_access_request_entity" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "status" character varying NOT NULL, "workspaceId" integer, "userId" integer, CONSTRAINT "PK_04c9b6a71a18dddf01d7207f1c1" PRIMARY KEY ("id"))`);
